// Legacy/utility file - recommended to use login.js, register.js, or dashboard.js instead
// Load API configuration (from app-config.js which must be loaded first in HTML)
