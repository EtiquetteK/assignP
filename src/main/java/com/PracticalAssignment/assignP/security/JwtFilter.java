...
public class JwtFilter extends OncePerRequestFilter {
    ...
    public JwtFilter(JwtUtil jwtUtil, UserDetailServiceImpl userDetailsService, TokenBlacklistService tokenBlacklistService) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        if (authHeader != null && authHeader.startsWith("Bearer ")
            ...
            if (tokenBlacklistService.isBlacklisted(token)) {
                log.debug("JwtFilter rejected blacklisted token for {} {}", request.getMethod(), request.getRequestURI());
            } else {
            try {
